...
import { useNeedsCrewSetup, useNeedsEquipmentPrompt, useNeedsPostAuthNotifications } from "@/hooks/use-onboarding";
...
export default function TabLayout() {
  ...
  if (isPending || (session && (crewLoading || notifLoading || equipmentLoading))) {
    return (
