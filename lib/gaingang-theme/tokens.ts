...
export const brand = {
  ...
  violet: '#9D4EDD', // Goal Violet — secondary
  violetDeep: '#7B35C2',
  violetGlow: '#C77DFF',
} as const;
...
/** Badge color palette — index 0 = levels 1–10, index 1 = 11–20, etc. */
...
export const type = {
  ...
  goalTitle: { fontFamily: fontFamily.display, fontSize: 26, lineHeight: 30 },
