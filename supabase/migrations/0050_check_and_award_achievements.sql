-- Award achievements based on live progress. Returns only newly earned rows.
-- Skips secret solo_day_clear (One Man Army) — deferred verifier.
...
begin
  ...
  -- Build eligible keys from counters (skip solo_day_clear).
