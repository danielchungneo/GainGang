-- Timed volume ladder + kudos-received milestones.
-- Unlocks stay in-app only (no notifications).
...
alter table public.achievements
  ...
  check (category in (
    'goal', 'quest', 'streak', 'reps', 'time', 'social', 'gang', 'rare', 'general'
  ));

insert into public.achievements (key, title, description, icon, category, threshold, is_secret, tier)
values
  ('time_10m',       'Hold Steady',    'Log 10 minutes of timed exercises',  'timer',    'time',   600,   false, 'bronze'),
  ('time_60m',       'Hourglass',      'Log 60 minutes of timed exercises',  'timer',    'time',   3600,  false, 'silver'),
  ('time_3h',        'Endurance',      'Log 3 hours of timed exercises',     'timer',    'time',   10800, false, 'gold'),
  ('time_10h',       'Iron Core',      'Log 10 hours of timed exercises',    'timer',    'time',   36000, false, 'platinum'),
  ('time_24h',       'Timeless',       'Log 24 hours of timed exercises',    'timer',    'time',   86400, false, 'legendary'),

  ('kudos_recv_1',   'Crowd Favorite', 'Receive your first kudos',           'sparkles', 'social', 1,     false, 'bronze'),
  ('kudos_recv_50',  'Spotlight',      'Receive 50 kudos',                   'sparkles', 'social', 50,    false, 'silver'),
  ('kudos_recv_250', 'Icon',           'Receive 250 kudos',                  'sparkles', 'social', 250,   false, 'gold')
