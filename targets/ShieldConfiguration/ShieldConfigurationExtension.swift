...
class ShieldConfigurationExtension: ShieldConfigurationDataSource {
  ...
  private let shieldTempUnlockTitle = "Unlocked"
  private let shieldTempUnlockSubtitle = "Your apps are ready. Try again in a moment."
  private let shieldTempUnlockButtonLabel = "OK"
  private let shieldPrimaryButtonColor = UIColor(red: 0.302, green: 0.549, blue: 1.000, alpha: 1.0)
  private let shieldBackgroundColor: UIColor? = UIColor(red: 0.020, green: 0.027, blue: 0.059, alpha: 1.0)
  private let shieldBlurStyle: UIBlurEffect.Style? = .systemThickMaterialDark
  private let shieldTitleColor = UIColor(red: 0.910, green: 0.929, blue: 0.969, alpha: 1.0)
  private let shieldSubtitleColor = UIColor(red: 0.682, green: 0.722, blue: 0.816, alpha: 1.0)
